appgateway_name                  = "xfin-tnp-prd-eus-appgateway"
vnet_rg_name                     = "xfin-tnp-prod-eus-pod1"
vnet_name                        = "SC9PROD"
gatewaysubnet                    = "subNet_AppGateway"
name                             = "xfin-tnp-prd-eus-appgw"
resource_group_name              = "xfin-tnp-prod-eus-cd2"
location                         = "eastus"
public_ip_address_name           = "SC9_PRD_AG"
resource_group_public_ip_address = "xfin-tnp-prd-eus-admin"
keyvault_name                    = "xfin-tnp-prd-eus-kv"
resource_group_keyvault          = "xfin-tnp-prd-eus-admin"
appgateway_msi_name              = "appgateway-prd-msi"
waf_policy_name                  = "DenyAll_WAF_Policy"
waf_policy_resource_group_name   = "xfin-tnp-prod-eus-cd2"
...
backend_address_pools = [
  {
    fqdns = ["xfin-tnp-prod-eus-cd.azurewebsites.net", "xfin-tnp-prod-eus-cd2.azurewebsites.net"]
    name  = "backendpool-east-cd"
  },
  {
    fqdns = ["xfin-tnp-prod-wus2-cd.azurewebsites.net", "xfin-tnp-prod-wus2-cd2.azurewebsites.net"]
    name  = "backendpool-west-cd"
  },
  {
    fqdns = ["xfin-tnp-prod-eus-cd.azurewebsites.net", "xfin-tnp-prod-eus-cd2.azurewebsites.net", "xfin-tnp-prod-wus2-cd.azurewebsites.net", "xfin-tnp-prod-wus2-cd2.azurewebsites.net"]
...
health_probes = [
  {
    ...
    path                                      = "/sitecore/service/keepalive.aspx"
    interval                                  = 30
    timeout                                   = 25
...
ssl_certificate_name     = "CMS9-AIO"
trusted_certificate_name = "ComodoRCA"

tags = {
  "Environment"              = "Production",
  "Cost Center"              = "IT",
  "Application Name"         = "sitecore9 CD",
